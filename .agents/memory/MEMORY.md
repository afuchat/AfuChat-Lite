...
- [Supabase realtime channel reuse](supabase-channel-reuse.md) — always use unique channel names per subscription to avoid "cannot add postgres_changes after subscribe" error.
